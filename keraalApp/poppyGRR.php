					...
					<tr>
						...
						<div class="tab_nom"><fieldset class="form-group">
							<select class="nom_exo_kine" id="exo_1" title="Nom de l'exercice composant le fichier à créer.">
								...
								<option value="etirementLaterauxBTendu">etirements Lateraux</option>
